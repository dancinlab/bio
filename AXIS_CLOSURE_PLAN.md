...
| 시점 | 마일스톤 |
|------|----------|
| ~now (human-rater 불요, user directive 2026-05-12) | **G26-RB-1′ + G26-NB-1′ deterministic computational verification rubric** 실행 (ribozyme 7-point math/physics; nanobot geometric/group + sim) → ribozyme & nanobot σ(6) CANDIDATE→EXACT *deductive* 도달. 기하/군 항목 즉시; **ribozyme sim ✅ DONE 2026-05-12** (in-repo re-impl `ribozyme_kinetics_simulation.py`); nanobot sim = 외부 `~/core/nexus/sim_bridge/` 재실행 (코드 부재). **ribozyme G26-RB-2 branch-lock ✅ DONE 2026-05-12.** |
