...
7. **Internal**: `theory/proofs/theorem-r1-uniqueness.md` (canon private SSOT, own#2). HEXA-COMP closure axioms originate here and feed `axiom_hexa_comp_closure_AX2`, `axiom_hexa_comp_closure_via_ZFC`.
...
| canon private framework (this repo) | `tool/own_doc_lint.py` | own#6 HARD gate |
